...
const CarouselMap = ({el ,Cardcs ,setCatgories , Catgories}) => {
    return (
        ...
        <div>
         ...
         {/* Image + animation */}
              <div className=" row-gap hoverimageAnimation heaightResposiveImageCarousel mt-11" style={{   borderRadius:"7px" }} >
                <img  className="h-110 w-250" style={{    borderRadius:"7px"}} src={process.env.PUBLIC_URL+`/${el.image}`}/>
